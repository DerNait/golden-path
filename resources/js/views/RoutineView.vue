...
const dayForm=reactive({}); const addForm=reactive({exercise_id:null,priority:'essential',target_sets:3,minimum_reps:8,maximum_reps:12,progression_target_reps:12,progression_target_total_reps:null,target_duration_seconds:null,target_weight:null,weight_unit:'lb',target_rir_min:1,target_rir_max:2,rest_seconds:120,weight_increment:5,progression_type:'double_progression',superset_group:null,notes:null});
