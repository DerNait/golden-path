...
class WorkoutExercise extends Model
{
    ...
    public function assistantRecommendation(): \Illuminate\Database\Eloquent\Relations\HasOne { return $this->hasOne(ProgressionRecommendation::class,'exercise_id','performed_exercise_id')->where('status','pending')->where('metadata_json->source','assistant')->latest('id'); }
