...
class RoutineExerciseRequest extends FormRequest
{
    ...
    public function rules(): array { return [
        ...
        'progression_target_reps'=>['nullable','integer','gte:minimum_reps','lte:maximum_reps'],
        'progression_target_total_reps'=>['nullable','integer','min:0','max:10000'],'target_duration_seconds'=>['nullable','integer','min:1','max:7200'],
